...
class MOTChallengeDataset(CocoVideoDataset):
    ...
    CLASSES = ( 'car', 'person', 'bus', 'bicycle')
    # CLASSES = ('car', 'bus')
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        for i, ann in enumerate(ann_info):
            ...
            if ann.get('ignore', False) or ann.get('iscrowd', False):
                ...
                # print('wjywjy', self.cat_ids)
                # print('2', ann['category_id'])
                # print('3', self.cat2label[ann['category_id']])
                # print('4', ann['instance_id'])
        ...
        if 'track' in metrics:
            ...
            hota = [
                np.average(output_res['MotChallenge2DBox']['track'][seq]
                           ['car']['HOTA']['HOTA']) for seq in seq_list
